...
import de.skubware.opentraining.activity.start_training.FExDetailFragment;
import de.skubware.opentraining.basic.FitnessExercise;

import static android.view.ViewGroup.LayoutParams.MATCH_PARENT;
import static android.view.ViewGroup.LayoutParams.WRAP_CONTENT;
import static com.examples.youtubeapidemo.VideoListDemoActivity.VideoListFragment.VIDEO_LIST;
 ...
 */
@TargetApi(13)
public final class VideoListDemoActivity extends Activity implements OnFullscreenListener, SearchView.OnQueryTextListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchView = (SearchView) findViewById(R.id.search_video_youtube);
    ...
    public boolean onQueryTextSubmit(String query) {
        ...
        try {
            ...
            for (SearchResult sr : searchResultList) {
                ...
                list.add(new VideoEntry(sr.getSnippet().getTitle(), sr.getId().getVideoId()));
            }
        ...
        VideoListFragment.VIDEO_LIST = Collections.unmodifiableList(list);
